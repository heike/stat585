...
x <- runif(1000)
qplot(x, binwidth=0.05) + ggtitle("Uniform Babies")
```
...
```{r, echo = FALSE}
qplot(rexp(1000, 4), binwidth=0.05) + ggtitle("The New Gammamountain")
```


And so the normal curve staid the elusive beast.